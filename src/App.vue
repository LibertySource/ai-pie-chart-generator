<template>
  <div class="bg-winter-blue text-deep-blue">
    ...
    <div class="container mx-auto max-w-3xl p-6">
      ...
      <div class="mb-6">
        <p>Supply a reasonable JSON string suitable for being displayed as a pie chart, and AI will be used to display the data using <a class="text-blue-500 underline"
            href="https://www.chartjs.org/docs/latest/api/" target="_blank">Chart.js</a></p>
      </div>
...
export default {
  ...
  setup() {
    ...
    const renderPieChart = (chartConfigString) => {
